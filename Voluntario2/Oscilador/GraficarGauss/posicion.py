...
datos = np.loadtxt("Voluntario2/Oscilador/DatosGaussCentrada/x_esperado.txt")
...
for i in range(0,len(datos),1):
    ...
    Teorico.append(equilibrio+(xc-equilibrio)*np.cos(w*i*s)+2*pc*np.sin(w*i*s)/w)
...
plt.show()
fig.savefig("Voluntario2/Imagenes/GaussianaCentrada/X.png")